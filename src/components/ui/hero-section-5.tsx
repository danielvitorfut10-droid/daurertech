                ...
                <div className="mx-auto w-fit rounded-full bg-white/10 backdrop-blur-xl shadow-[0_4px_30px_rgba(0,0,0,0.1),inset_0_0_15px_rgba(255,255,255,0.2)] border border-white/20 pl-4 pr-8 sm:pl-6 sm:pr-12 py-2 md:py-3 transition-all duration-300">
                    <motion.div className="flex items-center justify-center">
                        <div className="flex items-center justify-center gap-4 sm:gap-6">
                            ...
                            {/* Logo Inside */}
                            <a href="#home" className="flex-shrink-0 relative flex items-center justify-center w-32 md:w-44 h-8 md:h-10 mr-4 md:mr-12 z-10 transition-transform hover:scale-105 duration-300">
                                <img 
                                    src={logoSrc} 
                                    alt="Daurer Logo" 
                                    className="absolute inset-0 m-auto w-[130%] max-w-none h-auto object-contain pointer-events-none drop-shadow-lg" 
                                />
                            </a>
